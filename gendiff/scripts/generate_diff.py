...
def make_diff_str(file_one, file_two):
	#file_one = json.load(open('file1.json'))
	#file_two = json.load(open('file2.json'))
	...
	for key in sorted(keys):
		...
		diff_str += '\n' 
		#return compare_values(key, file_one, file_two)
		#print(compare_values(key, file_one, file_two))
	return diff_str
